...
exports.generatePythonApiTool = generatePythonApiTool;
exports.generatePythonFileTool = generatePythonFileTool;
exports.generatePythonDatabaseTool = generatePythonDatabaseTool;
exports.generatePythonToolsInit = generatePythonToolsInit;
...
function generatePythonToolsInit(config) {
    ...
    if (config.includeSecurity || config.includeObservability) {
        ...
        all_exports.push('"api_call_tool"', '"api_tool_schema"', '"read_file_tool"', '"write_file_tool"', '"file_tools_schema"', '"database_query_tool"', '"database_tool_schema"');
    }
    return `${imports.join('\n')}
