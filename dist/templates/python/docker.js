...
exports.generatePythonDockerfile = generatePythonDockerfile;
exports.generatePythonDockerCompose = generatePythonDockerCompose;
exports.generatePythonDockerIgnore = generatePythonDockerIgnore;
exports.generatePythonPrometheusConfig = generatePythonPrometheusConfig;
...
function generatePythonDockerCompose(config) {
...
function generatePythonDockerIgnore() {
    return `__pycache__/
*.py[cod]
*$py.class
*.so
...
function generatePythonPrometheusConfig() {
    return `global:
  scrape_interval: 15s
