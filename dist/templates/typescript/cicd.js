...
exports.generateGitHubActionsCI = generateGitHubActionsCI;
exports.generateGitHubActionsCD = generateGitHubActionsCD;
exports.generateGitHubActionsRelease = generateGitHubActionsRelease;
...
function generateGitHubActionsCD() {
    return `name: CD
...
function generateGitHubActionsRelease() {
    return `name: Release
